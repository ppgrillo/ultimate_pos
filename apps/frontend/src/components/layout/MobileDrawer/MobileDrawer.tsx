...
import { X, LayoutDashboard, ShoppingCart, ClipboardList, Package, Users, Settings, LogOut, Tag, BarChart3, Gift, ContactRound, Receipt, Calculator, Truck } from 'lucide-react'
